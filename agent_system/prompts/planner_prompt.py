...
- image_tool：根据提示词生成一张图片，返回图片链接和提示词信息
...
8. 意图为 image_generation 时：
   steps: [{"step_id": 1, "tool_name": "image_tool"}]
   need_llm_summary: false（图片结果主要通过图片卡片展示）
   summary_instruction: null

9. 意图为 commute_plan 时：
